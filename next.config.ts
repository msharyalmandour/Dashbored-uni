...
const nextConfig: NextConfig = {
  experimental: {
    serverActions: {
       ...
       *
       * 4mb, not the 40 the upload path used to advertise. The ceiling here is
       ...
       * The 500KB of headroom is for multipart boundaries and part headers,
       * which count toward the same limit.
       *
