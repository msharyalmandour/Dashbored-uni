const en = {
  ...
  inbox: {
    ...
    steps2: {
      identifying: "Identifying the content",
    ...
    notAnalyzed: "Saved, not analyzed",
    whyNotAnalyzed: "Why?",
    ...
    steps: {
      ...
      connecting: "Finding academic connections",
      placing: "Deciding where this belongs",
    },
    stepOutcome: {
      noConnections: "No course matched — you choose",
    ...
    noteLabel: "Note",
    analyze: "Analyze",
    analyzeAgain: "Try analyzing again",
    analyzing: "Reading it…",
    proposedBy: "Proposed by {provider}",
    proposalNote: "Nothing is saved to your records until you confirm.",
    confidenceHigh: "Confident",
    confidenceLow: "Not sure — check this",
    detectedSubject: "Subject",
    detectedTopics: "Topics",
    noSubjectDetected: "No subject detected",
    chooseSubject: "Choose a subject",
    noSubject: "No subject",
    fileAs: "File it as",
    destinations: {
      none: "Just file it",
      knowledgeGap: "Something to revisit",
      task: "A task",
    },
    destinationHint: {
      none: "Keeps the item, files the file under the subject, creates nothing else.",
      knowledgeGap: "Saves it as something to come back to.",
      task: "Adds it to Tasks with a deadline.",
    },
    titleLabel: "Title",
    notesLabel: "Notes",
