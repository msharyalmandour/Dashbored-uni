const en = {
  ...
  slides: {
    ...
    notAnnotatable: "The slide viewer can only draw a PDF or an image. Drop a PowerPoint into Drop Anything instead — it will read it and file it under this lecture.",
    uploadFailed: "The upload didn't finish. Check your connection and try again.",
    uploading: "Uploading…",
  ...
  inbox: {
    ...
    readWaitingCta: "Read my {count} waiting files",
    readWaitingBusy: "Reading…",
    readWaitingDone: "Read {count} files. They are searchable now.",
    readWaitingUnreadable: "{count} files were read but held nothing usable.",
    readWaitingRemaining: "{count} still waiting — press again to carry on.",
    readWaitingNothing: "Nothing was waiting to be read.",
    readWaitingFailed: "That didn't finish. Nothing was lost — press again.",
